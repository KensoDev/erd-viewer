...
func (e *DrawioExporter) Export(schema *db.SchemaData, selectedTables []string) (string, error) {
...
func (e *DrawioExporter) generateCells(tables []db.Table, fks []db.ForeignKey) []mxCell {
	cells := []mxCell{}
	vertex := 1
	edge := 1
	idCounter := 2
...
func (e *DrawioExporter) buildTableHTML(table db.Table) string {
	var sb strings.Builder

	sb.WriteString(fmt.Sprintf("<b>%s</b><br/>", escapeHTML(table.Name)))
